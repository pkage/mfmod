...
public class EventManager implements IWorldGenerator
{
    ...
    {
        this.addOreSpawn(Mfmod.creeperEssenseOre, world, random, x, z, 16, 16, 6 + random.nextInt(3), 15, 0, 100);
        this.addOreSpawn(Mfmod.denseIron, world, random, x, z, 16, 16, 6 + random.nextInt(3), 15, 0, 100);
    }
     ...
     * @param maxY An int for setting the maximum Z-Coordinate values for spawning on the Z-Axis on a Per-Chunk basis
